...
contract DexTwoFactory is Level(msg.sender) {
        ...
        returns (address instanceAddr)
    {
        ...
        SwappableTokenTwo tokenInstance =
            new SwappableTokenTwo(instanceAddr, "Token 1", "TKN1", 110);
        SwappableTokenTwo tokenInstanceTwo =
            new SwappableTokenTwo(instanceAddr, "Token 2", "TKN2", 110);
        ...
        returns (bool success)
    {
        ...
        success = IERC20(token1).balanceOf(_instance) == 0
            || IERC20(token2).balanceOf(_instance) == 0;
    }
}
