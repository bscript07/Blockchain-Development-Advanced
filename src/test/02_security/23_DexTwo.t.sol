...
import {
    ...
    SwappableTokenTwo,
    IERC20
} from "@/02_security/levels/23_DexTwo/DexTwoFactory.sol";
...
contract TestDexTwo is Tests {
    ...
    function setupLevel() internal override {
        ...
        assertTrue(
            token1.balanceOf(levelAddress) == 100
                && token2.balanceOf(levelAddress) == 100
        );
        assertTrue(
    ...
    function attack() internal override {
        ...
        SwappableTokenTwo fakeToken1 =
            new SwappableTokenTwo(address(level), "FakeToken", "FTN", 10_000);
        SwappableTokenTwo fakeToken2 =
            new SwappableTokenTwo(address(level), "FakeToken", "FTN", 10_000);
