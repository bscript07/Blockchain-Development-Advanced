...
import {
    PreservationFactory,
    Preservation
} from "@/02_security/levels/16_Preservation/PreservationFactory.sol";
import { MaliciousPreservation } from
    "@/02_security/levels/16_Preservation/MaliciousPreservation.sol";
...
contract TestPreservation is Tests {
    ...
    function attack() internal override {
        ...
        MaliciousPreservation maliciousPreservation =
            new MaliciousPreservation();
